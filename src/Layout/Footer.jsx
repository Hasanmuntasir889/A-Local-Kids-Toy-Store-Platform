...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-br  border-t border-gray-200">
      <div className="max-w-7xl mx-auto px-6 py-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div>
          <div className="text-2xl flex flex-row items-center space-x-1 mb-3  ">
            ...
            <h2 className="text-2xl font-bold text-primary ">TradeSmart</h2>
          </div>
        ...
        <div>
          ...
          <div className="flex space-x-4">
            <a
              href="#"
              className="p-3 bg-white rounded-full shadow hover:bg-primary hover:text-white transition"
            >
              <FaFacebookF />
            </a>
            <a
