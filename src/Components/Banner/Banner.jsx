...
import BannerLogo from "../../assets/img/TLMS_20240104_1200x628-1.png";
  ...
  return (
    <div className="container mx-auto  ">
        ...
        <SwiperSlide>
          <div className="relative flex flex-col-reverse lg:flex-row justify-between items-center px-6 lg:px-10 w-full min-h-screen overflow-hidden bg-gradient-to-br from-white via-blue-50 to-purple-50">
            ...
            <div className="relative z-10 flex-1 flex justify-center items-center">
              ...
              {/* Card 1 - Active Users */}
              <div
                className="absolute flex items-center gap-3 w-[160px] sm:w-[180px] h-[60px] sm:h-[70px] 
      ...
      hover:bg-white/40 transition-all duration-300"
              ...
              <div className="absolute flex items-center gap-3 w-[160px] sm:w-[180px] h-[60px] sm:h-[70px] bg-white/30 border border-white/20 rounded-xl backdrop-blur-md shadow-lg p-4 top-[30%] right-[8%] hover:bg-white/40 transition-all duration-300">
              ...
              <div className="absolute flex items-center gap-3 w-[160px] sm:w-[180px] h-[60px] sm:h-[70px] bg-white/30 border border-white/20 rounded-xl backdrop-blur-3xl shadow-lg p-4 bottom-[10%] right-[10%] hover:bg-white/40 transition-all duration-300">
