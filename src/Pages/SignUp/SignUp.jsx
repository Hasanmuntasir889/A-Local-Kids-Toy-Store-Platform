...
export default function SignUp() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-indigo-50 via-white to-sky-100 flex items-center justify-center px-4 py-4">
      <div className="max-w-5xl w-full grid md:grid-cols-2 bg-white/80 backdrop-blur-xl shadow-2xl rounded-3xl overflow-hidden border border-indigo-100">
        <div className="hidden md:flex flex-col justify-center items-center bg-linear-to-br from-indigo-700 via-blue-600 to-cyan-500 text-white p-4 relative overflow-hidden">
          <h1 className="text-5xl font-extrabold mb-4">
            <span className="text-yellow-300">TradeSmart</span>
          </h1>
          <p className="text-lg opacity-90 text-center leading-relaxed">
            Empower your community through shared skills — teach, learn, and
            grow together with people near you.
          </p>
        ...
        <div className="p-4 md:p-14 flex flex-col justify-center">
          <div className="mb-8 text-center">
            ...
            <p className="text-gray-500 text-sm">
              Create your account to start sharing your skills, learning new
              ones, and connecting with your local community.
            </p>
          </div>
